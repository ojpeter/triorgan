...
export default function AuthGateModal({
  ...
  const description = organName
    ? `To run a ${organName} screening and save your results, you need a free HeLiK account.`
    : `To use ${feature}, you need a free HeLiK account. It takes less than a minute.`;
