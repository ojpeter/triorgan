...
log = logging.getLogger("triacare.analysis")

SYSTEM_PROMPT = """You are TriaCare AI, a medical health screening assistant specialised in early warning detection of heart, kidney and liver disease for East Africa (Uganda).
